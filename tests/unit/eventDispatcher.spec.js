...
describe('Event Dispatcher', () => {
  ...
  it('track a product reorder event', () => {
    store.dispatch('events/productReorder')
    expect(wrapper.vm.logEntry.eventType).toEqual('PRODUCT_REORDER')
  })

  it('track a pause subscription event', () => {
    store.dispatch('events/pauseSubscription')
    expect(wrapper.vm.logEntry.eventType).toEqual('PAUSE_SUBSCRIPTION')
  })
})
